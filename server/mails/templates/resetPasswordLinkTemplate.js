    ...
    <body>
        <div class="container">
            <a href=${process.env.REACT_APP_LINK}><img class="logo"
                    src="https://i.ibb.co/7Xyj3PC/logo.png" alt="StudyForge Logo"></a>
            <div class="message">Password Recovery Link</div>
            <div class="body">
                <p>Hey ${name},</p>
                <p>You recently requested to reset the password for your StudyForge account [registered email with us : ${email}]. Click the link below to proceed.
                </p>
